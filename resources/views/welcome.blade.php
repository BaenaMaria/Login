    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <img src="https://is4-ssl.mzstatic.com/image/thumb/Purple111/v4/07/72/6a/07726a15-3b7c-fefa-d399-4db0c6062d4e/source/256x256bb.jpg"  width = "75" height = "75" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Accede a todas tus aplicaciones de manerarápida y sencilla sin tener que hacer login enc ada una de ellas.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://ayudatpymes.com/" class="underline text-gray-900 dark:text-white">AYUDAT PYMES</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    El servicio de gestoría online para empresas y autónomos más innovador de España.
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            ...
                            <a href="https://ayudatpymes.com/tarifas/" class="ml-1 underline">
                                Shop
                            </a>
